#!/usr/bin/env bash
# Deterministische Scroll-Scrub-Encodes für den Nala-Moon-Film.
#   bash higgsfield/encode-film.sh desktop       source.mp4  assets/film/nalamoon-desktop.mp4
#   bash higgsfield/encode-film.sh mobile        source.mp4  assets/film/nalamoon-mobile.mp4
#   bash higgsfield/encode-film.sh portrait      portrait.mp4 assets/film/nalamoon-portrait.mp4
#   bash higgsfield/encode-film.sh desktop-webm  source.mp4  assets/film/nalamoon-desktop.webm
#   bash higgsfield/encode-film.sh mobile-webm   source.mp4  assets/film/nalamoon-mobile.webm
#   bash higgsfield/encode-film.sh portrait-webm portrait.mp4 assets/film/nalamoon-portrait.webm
